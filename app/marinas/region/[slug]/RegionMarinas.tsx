...
import { MarinaWithCity } from "@/types/marina-with-city";

  
  interface RegionMarinasProps {
    marinas: MarinaWithCity[];
  }

  const RegionMarinas = ({ marinas }: RegionMarinasProps) => {
    return (
          ...
          <div className="mb-14 flex items-end justify-between gap-6">
            <div>
              ...
              <h2 className="mt-3 font-cormorant-garamont text-5xl font-bold text-darknavy">
                Bölgedeki En Popüler Marinalar
              </h2>
