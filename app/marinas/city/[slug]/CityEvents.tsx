        ...
        <div className="mb-14 flex items-end justify-between gap-6">
          <div>
            ...
            <h2 className="mt-3 font-cormorant-garamont text-5xl font-bold text-darknavy">
              Şehirdeki Öne Çıkan Etkinlikler
            </h2>

            <p className="mt-4 max-w-2xl text-darknavy/70">
              Bu şehirde gerçekleşen yelken yarışlarını, festivalleri
              ve denizcilik etkinliklerini keşfedin.
            </p>
          </div>
        ...
        {events.length > 0 ? (
          ...
          ">
            <p className="text-darknavy/60">
              Bu şehirde henüz etkinlik bulunmuyor.
            </p>
          </div>
        )}
